...
7. Interrupt & resume
  ...
  - There is only one way to make a 'safe' interruption which is to tap 'qg' quickly. This will signal the scanner to skip the rest of its queue and after all remaining downloads get processed the app will exit normally
